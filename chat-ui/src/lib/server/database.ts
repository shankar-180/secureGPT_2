...
const document = db.collection<Document>("documents");
const group = db.collection<Group>("groups");
const userSettings = db.collection<Group>("userSettings");
const assistants = db.collection<Group>("assistants");
const models = db.collection<Model>("models");
